...
const M2VelocityChart = ({ data }) => {
    ...
    const getFilteredData = () => {
        ...
        return data.filter(item => new Date(item.date) >= startDate && item.m2Velocity !== null);
    };
        ...
        <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 shadow-xl">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    ...
                    <p className="text-slate-400 text-sm mt-1">Velocity of M2 Money Stock (GDP / M2)</p>
                </div>

                <div className="flex flex-col items-end gap-2">
                    <div className="text-2xl font-bold text-slate-100">
                        {filteredData.length > 0 ? filteredData[filteredData.length - 1].m2Velocity?.toFixed(3) : '0.000'}
                    </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={filteredData}>
                        ...
                        <Tooltip
                            ...
                            formatter={(value) => [value.toFixed(3), 'M2 Velocity']}
...
export default M2VelocityChart;
