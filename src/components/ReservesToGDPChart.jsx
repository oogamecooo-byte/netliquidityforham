...
const ReservesToGDPChart = ({ data }) => {
    ...
    const getFilteredData = () => {
        ...
        return data.filter(item => new Date(item.date) >= startDate && item.reservesToGdpRatio !== null);
    };
...
export default ReservesToGDPChart;
