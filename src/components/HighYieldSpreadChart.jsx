...
const HighYieldSpreadChart = ({ data }) => {
    ...
    const getFilteredData = () => {
        ...
        return data.filter(item => new Date(item.date) >= startDate && item.highYieldSpread !== null && item.highYieldSpread !== undefined);
    };

    const chartData = getFilteredData();
    const latestValue = chartData.length > 0 ? chartData[chartData.length - 1].highYieldSpread : 0;
...
export default HighYieldSpreadChart;
